...
describe('Weight e2e test', () => {
    ...
    it('should load Weights', () => {
        ...
        expect(weightComponentsPage.getTitle()).toMatch(/jhprojApp.weight.home.title/);
    ...
    it('should load create Weight dialog', () => {
        ...
        expect(weightDialogPage.getModalTitle()).toMatch(/jhprojApp.weight.home.createOrEditLabel/);
