...
describe('BloodPressure e2e test', () => {
    ...
    it('should load BloodPressures', () => {
        ...
        expect(bloodPressureComponentsPage.getTitle()).toMatch(/jhprojApp.bloodPressure.home.title/);
    ...
    it('should load create BloodPressure dialog', () => {
        ...
        expect(bloodPressureDialogPage.getModalTitle()).toMatch(/jhprojApp.bloodPressure.home.createOrEditLabel/);
