...
describe('Points e2e test', () => {
    ...
    it('should load Points', () => {
        ...
        expect(pointsComponentsPage.getTitle()).toMatch(/jhprojApp.points.home.title/);
    ...
    it('should load create Points dialog', () => {
        ...
        expect(pointsDialogPage.getModalTitle()).toMatch(/jhprojApp.points.home.createOrEditLabel/);
